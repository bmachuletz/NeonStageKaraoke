...
def load_wav(path, device, sample_rate=None):
    ...
    if installed_torchaudio:
        try:
            ...
            # New TorchAudio releases delegate decoding to TorchCodec, whose
            # CUDA wheel can be unavailable even though FFmpeg is installed.
            # Librosa keeps SOFA inference independent from that ABI detail.
