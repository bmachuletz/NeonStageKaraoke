...
class BasicPitchPostprocessTests(unittest.TestCase):
    def test_provided_selected_analysis_stem_is_not_reseparated(self):
        with tempfile.TemporaryDirectory() as root:
            ...
            with patch("app.basic_pitch_postprocess.ffmpeg_to_mono16k",
                 ...
                 patch("app.basic_pitch_postprocess.separate_stems") as separate:
                result = run(
            ...
            self.assertEqual(
                "provided-selected-analysis-stem",
                report["basic_pitch_analysis"]["analysis_audio_source"])
