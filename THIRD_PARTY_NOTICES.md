...
| yt-dlp | checksum-verified video/audio acquisition tool bundled with server releases | The Unlicense; operators must additionally observe applicable site terms and use it only where authorized |
| Deno | bundled JavaScript runtime used by yt-dlp for provider challenges | MIT License |
