...
if not defined Karaoke__PublicBaseUrl set "Karaoke__PublicBaseUrl=http://127.0.0.1:5274"
if not defined ASPNETCORE_URLS set "ASPNETCORE_URLS=http://0.0.0.0:5274"
