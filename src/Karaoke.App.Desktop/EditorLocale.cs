...
public static class EditorLocale
{
    ...
    private static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
    {
        ...
        ["Spotify, Qobuz oder YouTube: Titel oder Interpret suchen …"]="Spotify, Qobuz, or YouTube: search title or artist …",
        ...
        ["Ist das Plugin deaktiviert oder unvollständig konfiguriert, verwendet Neon Stage weiterhin YouTube. Bei aktiviertem Qobuz gibt es keinen stillen YouTube-Fallback."]="When the plugin is disabled or incomplete, Neon Stage continues to use YouTube. There is no silent YouTube fallback while Qobuz is enabled.",
