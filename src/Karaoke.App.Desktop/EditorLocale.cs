...
public static class EditorLocale
{
    ...
    private static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
    {
        ...
        ["Nach dem Import mit Variante 1.2 an die lokale Vocalspur anpassen"]="After import, align Variant 1.2 to the local vocal track",
        ...
        ["Metadaten → Sidecar/Tag/LRCLIB oder Volltranskript → Variante 1.2 → Review"]="Metadata → sidecar/tag/LRCLIB or full transcript → Variant 1.2 → review",
