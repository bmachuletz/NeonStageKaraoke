(function () {
  ...
  const en = {
    ...
    'Spotify verbinden':'Connect Spotify','Bei Spotify suchen':'Search Spotify','Bei Spotify oder Qobuz suchen':'Search Spotify or Qobuz','Bei Spotify, Qobuz oder YouTube suchen':'Search Spotify, Qobuz, or YouTube',
    ...
    'Spotify ist nicht konfiguriert – die Suche verwendet Nur-YouTube.':'Spotify is not configured — search uses YouTube only.',
    ...
    'Spotify/Qobuz werden durchsucht; falls nötig folgt Nur-YouTube …':'Searching Spotify/Qobuz; YouTube-only fallback follows when needed …',
    'Katalogsuche läuft; falls nötig mit Nur-YouTube-Fallback …':'Searching catalogs, with YouTube-only fallback when needed …',
    'In YouTube öffnen ↗':'Open in YouTube ↗','Katalogsuche fehlgeschlagen. Auch YouTube war nicht erreichbar.':'Catalog search failed. YouTube was unavailable too.',
