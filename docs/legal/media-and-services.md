# Media, lyrics and online services

Neon Stage is software for processing and playing media supplied or lawfully accessed by its operator. The project does not provide music, lyrics or cover art and does not grant rights in them.
...
- Genius results are discovery links only. The official API does not provide
  lyrics text, and Neon Stage does not scrape the linked pages.
- USDB/UltraStar TXT files may contain copyrighted lyrics and community-authored timing data. Public web availability does not grant redistribution rights. Neon Stage is not affiliated with or endorsed by UltraStar DataBase.
- Local or YouTube video selection is an operator action. Search/download
  tooling does not grant synchronization, reproduction, download, or public
  performance rights; only use video material you are authorized to use.
